...
## [0.3.0](https://github.com/dmty/RunwayGauge/compare/v0.2.0...v0.3.0) (2026-09-23)
...
* add Codex discovery setting ([6594720](https://github.com/dmty/RunwayGauge/commit/659472052cc8782fd03dd67d6e2a4f20e9587185))
* add Codex source account model ([7076ed2](https://github.com/dmty/RunwayGauge/commit/7076ed24aeb206a0a349b2df3122b4c9e78692f1))
...
* discover Codex through app server ([dd90c04](https://github.com/dmty/RunwayGauge/commit/dd90c044dd82cc3a18653ef66ef0063a7d9d6d41))
...
* map Codex app-server limits ([30a2481](https://github.com/dmty/RunwayGauge/commit/30a24812d45dc7440ac285d46fa67a00322c8864))
* poll pinned Codex usage ([e66e11a](https://github.com/dmty/RunwayGauge/commit/e66e11a51106323ff81d3a6b0d5d83b3ca3da24d))
* render Codex usage panes ([1cee1ce](https://github.com/dmty/RunwayGauge/commit/1cee1ce7d38bb4d5a47296dc07dae8daa36dd198))
* **scripts:** add Developer ID sign, notarize, install pipeline ([40a0c66](https://github.com/dmty/RunwayGauge/commit/40a0c66455b997e91b2fee3a366d199d988a7159))
...
* **app:** resync installed helpers on launch when bundle changes ([16d1357](https://github.com/dmty/RunwayGauge/commit/16d13572d7b6d5289a4c0f579466a7a168d82d1c))
* arbitrate Codex deadline before shutdown ([6cbf034](https://github.com/dmty/RunwayGauge/commit/6cbf0345c24a6efb3be2966a69cfa68742348fa2))
* close final Sol review findings ([3f941c2](https://github.com/dmty/RunwayGauge/commit/3f941c2501bcddc902acabe211f3a6b96bef3386))
...
* harden Codex app-server client races ([7568a65](https://github.com/dmty/RunwayGauge/commit/7568a651cadd931259779e7c0ae4d57237fadc5b))
* **helper:** read Claude tokens via security CLI to avoid keychain prompts ([db51aaa](https://github.com/dmty/RunwayGauge/commit/db51aaa5a0eeaa0092f86b21103676cbb1163943))
...
* **poller:** refresh statusline-only Claude usage ([4f1b929](https://github.com/dmty/RunwayGauge/commit/4f1b9294457ca79508aaf7679d2da85c843cb61c))
* **poll:** keep Session when five_hour omitted ([fd00173](https://github.com/dmty/RunwayGauge/commit/fd001738daa249d23fd1a8c4e05ab74d55d1a352))
* preserve Codex merge fields and public init ([2271152](https://github.com/dmty/RunwayGauge/commit/22711522b740ad95bf4ad9ec992fb53cd3705c29))
...
* preserve Keychain accounts on discovery failure ([6f05d7d](https://github.com/dmty/RunwayGauge/commit/6f05d7d3379cd14599dd07959ec04a63480211cb))
* **scripts:** bundle freshly built helper regardless of SwiftPM output dir ([b9567ab](https://github.com/dmty/RunwayGauge/commit/b9567ab0fff8b8661402692f6387768bd31b72ce))
...
* **widget:** fit three compact usage rows ([e4d9491](https://github.com/dmty/RunwayGauge/commit/e4d94916ffb0ac25c9383aca66c1de045b6239cb))
* **widget:** show Claude plan name ([61446d6](https://github.com/dmty/RunwayGauge/commit/61446d68dc15257f268340949e453ed06130adf2))
